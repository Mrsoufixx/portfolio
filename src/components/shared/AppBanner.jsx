    ...
    >
      <div className="w-full md:w-2/4 text-left">
        ...
        <motion.h1
          ...
          className="font-general-semibold text-2xl lg:text-3xl xl:text-4xl text-center sm:text-left text-ternary-dark dark:text-primary-green"
        >
          {"<"}Soufiane KORCHI {"/>"}
        </motion.h1>
        <motion.p
          ...
          className="font-general-medium mt-8 text-md md:text-lg lg:text-lg xl:text-xl text-center sm:text-left leading-normal text-gray-500 dark:text-gray-200"
        >
          A Full-Stack Developer & Ux/Ui Designer
        </motion.p>
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
