...
const socialLinks = [
  {
    id: 1,
    icon: <FaGithub />,
    url: 'https://github.com/Mrsoufixx',
  },
  {
    id: 2,
    icon: <FaInstagram />,
    url: 'https://www.instagram.com/soufianekor/',
  },
  {
    id: 3,
    icon: <FaLinkedin />,
    url: 'https://www.linkedin.com/in/soufiane-korchi/',
  },
  {
    id: 4,
    icon: <FaWhatsapp />,
    url: 'https://api.whatsapp.com/send?phone=212602880383',
  },
